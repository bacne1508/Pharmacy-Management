...
$(document).ready(function() {
    ...
    $('#edit-submit-btn').click(function () {
        ...
        fetch('/api/auth/medicine/type/edit', {
	        method: 'POST',
	        headers: {
    ...
    $('#add-submit-btn').click(function () {
        ...
        fetch('/api/auth/medicine/type/add', {
	        method: 'POST',
	        headers: {
	            'Content-Type': 'application/json'
	        },
...
function fetchUsersSearch(page, size) {
	...
	let url = `/api/auth/medicine/type/all?page=${page}&size=${size}`;
	if (name) {
...
function fetchUsers(page) {
	fetch(`/api/auth/medicine/type/all?page=${page}&size=${size}`)
		.then(res => res.json())
		.then(data => {
			if (data.success) {
...
function delRole(id) {
    ...
    $('#commitRoleDel').off('click').on('click', function () {
		fetch(`/api/auth/medicine/type/delete?id=${id}`)
		.then(res => res.json())
		.then(data => {
			if (data.success) {
