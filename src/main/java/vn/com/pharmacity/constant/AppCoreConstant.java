...
public class AppCoreConstant {
	...
	public static final String TABLE_LAB_TESTS = "LabTests";
	public static final String TABLE_PRESCRIPTIONS = "Prescriptions";
	public static final String TABLE_DRUG_INVENTORY = "DrugInventory";
	public static final String TABLE_PRESCRIPTION_ITEMS = "PrescriptionItems";
	public static final String TABLE_BILLS = "Bills";
	public static final String TABLE_BILL_ITEMS = "BillItems";
