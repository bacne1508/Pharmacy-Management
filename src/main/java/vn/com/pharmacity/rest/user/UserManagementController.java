...
public class UserManagementController {
    ...
    public ResponseEntity<ResponseVO> searchAllMovie(
        ...
        Page<UserDto> userPage = adminAccountService.searchAllUser(userName, fullName, email, phone ,pageable);
    ...
    public ResponseVO deleteRole(@RequestParam("id") Integer id) {
        ...
        if (!isDeleted) {
            throw new SystemException("Delete employ failed");
        }
        return isDeleted ? ResponseVO.buildSuccess("Delete employ successfully") : ResponseVO.buildFailure("Delete employ failed");
    }
